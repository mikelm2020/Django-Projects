    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('main_image', models.ImageField(upload_to='product', verbose_name='imagen principal')),
                ('image1', models.ImageField(blank=True, null=True, upload_to='product', verbose_name='Imagen 1')),
                ('image2', models.ImageField(blank=True, null=True, upload_to='product', verbose_name='Imagen 2')),
                ('image3', models.ImageField(blank=True, null=True, upload_to='product', verbose_name='Imagen 3')),
                ('image4', models.ImageField(blank=True, null=True, upload_to='product', verbose_name='Imagen 4')),
