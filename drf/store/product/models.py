...
class Product(TimeStampedModel):
    ...
    image1 = models.ImageField('Imagen 1', blank=True, null=True, upload_to='product')
    image2 = models.ImageField('Imagen 2', blank=True, null=True, upload_to='product')
    image3 = models.ImageField('Imagen 3', blank=True, null=True, upload_to='product')
    image4 = models.ImageField('Imagen 4', blank=True, null=True, upload_to='product')
